 ...
 useEffect (()=>{
  ...
  return (
    <div>
      ...
      <main>
<h1 className=' font-bold text-2xl relative top-10 left-100'>EDIT STUDENT</h1>
      <form onSubmit={(e)=>{e.preventDefault(),HandleEdit()}} className='grid bg-white space-y-2 p-5 relative top-15 left-50 w-150 shadow-lg rounded-lg border-2 border-gray-200'>
